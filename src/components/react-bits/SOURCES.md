...
The upstream license is preserved in LICENSE.md. These are local adaptations, not a package claiming to be the React Bits library. Motion and GSAP are the runtime dependencies.
