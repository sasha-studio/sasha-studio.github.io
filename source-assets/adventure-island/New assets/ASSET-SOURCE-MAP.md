# Adventure Island original artwork

Original full-resolution PNGs supplied for this update. Optimized WebP versions are used on the site.

## Source-to-web mapping

- `Cover.png` → `public/media/adventure-island/adventure-island-cover.webp`
- `ChatGPT Image 23 сент. 2026 г., 23_18_50 1.png` → `public/media/adventure-island/elements/01-adventure-island-title-logo.webp`
- `Group 6676.png` → `public/media/adventure-island/elements/02-quest-book-overview.webp`
- `Group 6697.png` → `public/media/adventure-island/maps/01-parchment-map.webp`
- `Group 6698.png` → `public/media/adventure-island/maps/02-island-map-variation.webp`
- `Group 6703.png` → `public/media/adventure-island/elements/03-dog-dialogue-panel.webp`
- `Group 6706.png` → `public/media/adventure-island/elements/04-character-collection-screens.webp`
- `Group 6714.png` → `public/media/adventure-island/elements/05-magic-book-item.webp`
- `Group 6737.png` → `public/media/adventure-island/maps/03-map-assets-overview.webp`
